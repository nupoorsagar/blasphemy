...
export async function POST(req:Request,{params}:{params:Promise<{id:string}>}){
 ...
 const {id}=await params; const body=await req.json(); const updated=updateAudit(id,{status:'complete',pages:body.pages||[],findings:body.findings||[],aiSummary:body.aiSummary||undefined});
